...
import { Loader2, Eye, EyeOff, Lock, User as UserIcon, ShieldCheck, ArrowRight } from "lucide-react";
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-(--background) flex items-center justify-center p-4 relative overflow-hidden font-cairo" dir="rtl">
      ...
      <Link 
        href="/" 
        className="absolute top-6 right-6 z-50 flex items-center gap-2 text-white/50 hover:text-[#F58220] hover:bg-[#F58220]/10 px-4 py-2 rounded-xl transition-all font-bold text-sm border border-transparent hover:border-[#F58220]/20"
      >
        <ArrowRight size={16} />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10 relative">
          <motion.div 
            ...
            className="w-32 h-32 mb-6 drop-shadow-[0_0_15px_rgba(245,130,32,0.3)]"
          >
            <Logo />
          </motion.div>
          
          <h1 className="text-3xl font-black text-white uppercase tracking-tight mb-2">تسجيل الدخول</h1>
